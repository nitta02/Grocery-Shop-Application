...
import 'package:grocery_shop_app/presentation/pages/emtyScreen.dart';
...
class CartPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isEmpty = Provider.of<ProductProvider>(context).cartItems.isEmpty;
                              ...
                              children: [
                                ...
                                Consumer<ProductProvider>(
                                  builder: (context, value, child) {
                                    ...
                                    final totalPrice = value.cartItems.fold<
                                            double>(
                                        0,
                                        (sum, item) =>
